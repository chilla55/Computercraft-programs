...
names = ['discovery', 'app', 'common', 'runtime', 'protection', 'regulation', 'planner', 'ui', 'interface', 'updater', 'sha256', 'thermal_protection', 'transformer']
...
(root / 'approved-release.json').write_text(json.dumps(manifest, indent=2, sort_keys=True) + '\n')
